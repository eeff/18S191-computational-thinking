...
# ╔═╡ 941938ed-8856-408a-bd5d-9c61b39ac8ec
my_sum([1 2 3
4 5 6])
...
# ╔═╡ 2c178592-efde-409b-90ce-2977c79253dc
mean([1 2 3
4 5 6])
...
# ╔═╡ d73f00cf-fb6d-4902-a216-b32871754c08
function get_greens(img::AbstractMatrix)
	return get_green.(img)
end

# ╔═╡ 407d1f65-e590-4012-9633-e869d5795295
function get_blue(pixel::AbstractRGB)
	return pixel.b
end

# ╔═╡ d15c9c35-48b1-4d46-bb82-0e36996a5bed
function get_blues(img::AbstractMatrix)
	get_blue.(img)
end
...
# ╔═╡ a4f117c5-46e5-4be1-af76-db75ddb3d391
...
function custom_filter(pixel::AbstractRGB)	
	return RGB(quantize(pixel.r), noisify(pixel.g, 0.3), pixel.b)
end
